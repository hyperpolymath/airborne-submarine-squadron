...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/airborne-submarine-squadron/security/advisories/new)
...
- This repository (`hyperpolymath/airborne-submarine-squadron`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/airborne-submarine-squadron/security/advisories)
...
When using Airborne Submarine Squadron, we recommend:
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/airborne-submarine-squadron/security/advisories/new) or 6759885+hyperpolymath@users.noreply.github.com |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/airborne-submarine-squadron/discussions) |
...
*Thank you for helping keep Airborne Submarine Squadron and its users safe.* 🛡️
