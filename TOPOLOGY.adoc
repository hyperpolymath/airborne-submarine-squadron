...
A browser-forward arcade flight game built on Gossamer launcher.
Features atmosphere flight, underwater combat with thermal layers,
orbital space navigation, three ship types, and commander ejection
system. Core game logic in AffineScript/WASM wrapped by Gossamer
frontend; focus on gameplay loop stability and cross-platform builds.
