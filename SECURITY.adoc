...
[arabic]
. Navigate to
https://github.com/hyperpolymath/airborne-submarine-squadron/security/advisories/new[Report
a Vulnerability]
...
* This repository (`+hyperpolymath/airborne-submarine-squadron+`) and
all its code
...
https://github.com/hyperpolymath/airborne-submarine-squadron/security/advisories[Security
Advisories]
...
|*General questions*
|https://github.com/hyperpolymath/airborne-submarine-squadron/discussions[GitHub
Discussions]
...
_Thank you for helping keep Airborne Submarine Squadron and its users
safe._ 🛡️
