= RSR Compliance: airborne-submarine-squadron
:toc:
:sectnums:

== Overview

This document describes the Rhodium Standard Repository (RSR) compliance status for *airborne-submarine-squadron*.
