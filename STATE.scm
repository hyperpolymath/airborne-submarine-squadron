...
(define metadata
  '((version . "0.1.0")
    ...
    (repo . "github.com/hyperpolymath/airborne-submarine-squadron")))
...
(define project-context
  '((name . "airborne-submarine-squadron")
    (tagline . "A 2D flying submarine game written in Ada 2022, inspired by Sopwith. Control a submarine that seamlessly transitions between aerial and underwater combat.")
    (version . "0.1.0")
