...
// Obstacle initialization functions
...
fn init_obstacles() -> Obstacles {
  return { a: init_obstacle(), b: init_obstacle(), c: init_obstacle(), d: init_obstacle() };
}
...
// Utility functions for power-ups and obstacles
...
fn spawn_powerups(world: World) -> World {
  if world.powerups.a.active && world.powerups.b.active && world.powerups.c.active {
    return world;
  };
  
  if world.tick % 60 == 0 && rand_int(100) < 15 {
    if !world.powerups.a.active {
      return spawn_in_powerup_slot(world, "a");
    } else if !world.powerups.b.active {
      return spawn_in_powerup_slot(world, "b");
    } else {
      return spawn_in_powerup_slot(world, "c");
    };
  };
  return world;
}

fn spawn_in_powerup_slot(world: World, slot: String) -> World {
  let x = 850;
  ...
  let powerup_type =
    if rand < 20 {
      ...
      PowerUpType::EnvironmentControl;
    };
  ...
  let powerup = { x: x, y: y, powerup_type: powerup_type, active: true, duration: duration, spawn_tick: world.tick };
  ...
  if slot == "a" {
    return {
      ...
      last_input: world.last_input,
      powerups: { a: powerup, b: world.powerups.b, c: world.powerups.c },
      active_powerups: world.active_powerups,
    ...
    return {
      ...
      mission: world.mission,
      last_input: world.last_input,
      powerups: { a: world.powerups.a, b: powerup, c: world.powerups.c },
      active_powerups: world.active_powerups,
      obstacles: world.obstacles,
      active_effects: world.active_effects
    };
    ...
    return {
      ...
      mission: world.mission,
      last_input: world.last_input,
      powerups: { a: world.powerups.a, b: world.powerups.b, c: powerup },
      active_powerups: world.active_powerups,
      obstacles: world.obstacles,
      active_effects: world.active_effects
    };
...
fn check_powerup_collisions(world: World, sub: Submarine) -> World {
