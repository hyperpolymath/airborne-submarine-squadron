...
:experimental:
:url-github: https://github.com/hyperpolymath/airborne-submarine-squadron
:url-gitlab: https://gitlab.com/hyperpolymath/airborne-submarine-squadron
:url-bitbucket: https://bitbucket.org/hyperpolymath/airborne-submarine-squadron
:url-codeberg: https://codeberg.org/hyperpolymath/airborne-submarine-squadron

Amphibious deployment orchestration for hybrid environments
...
airborne-submarine-squadron is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
